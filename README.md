...
![share_lib](http://onmw6wg88.bkt.clouddn.com/share_lib.png)
...
* 多次import一个模块时，是否多次执行模块中没有写在 \__name__=__main__ 下面的代码？
...
答案：该函数详细说明可以参考：[Format Strings for PyArg_ParseTuple()](https://docs.python.org/2.0/ext/parseTuple.html)
